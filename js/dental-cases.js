window.__DDLE_CASES__ = [
  {
    id: 1,
    answer: "Trigeminal neuralgia",
    clues: [
      "A 58-year-old woman reports episodes of sudden, severe facial pain on the right side.",
      "The pain lasts only seconds but is described as electric shock-like or stabbing.",
      "Episodes are triggered by chewing, speaking, or light touch to the right cheek.",
      "Neurological examination is entirely normal between attacks.",
      "MRI reveals vascular contact and distortion at the nerve root entry zone adjacent to the right side of the pons.",
      "The attacks are confined to the V2 and V3 distributions of the right fifth cranial nerve, with no sensory deficit between episodes."
    ],
    description: "Trigeminal neuralgia is a neuropathic pain disorder of the trigeminal nerve characterised by brief, severe, unilateral facial pain triggered by light tactile stimuli. It is most commonly caused by vascular compression at the nerve root entry zone. Carbamazepine is first-line treatment; microvascular decompression is curative for refractory cases.",
    ankiStep1: "",
    ankiStep2: ""
  },
  {
  ...
  },
  {
    ...
    clues: [
      "A 52-year-old woman reports a burning sensation in her mouth that has been present for several months.",
      "She notices a white lacy pattern on both buccal mucosae that does not wipe off.",
      "The lesions are bilateral and roughly symmetrical.",
      "Skin examination reveals flat-topped, violaceous, polygonal papules on her wrists.",
      "Biopsy of the buccal mucosa shows a band-like lymphocytic infiltrate at the epithelial-connective tissue interface with saw-tooth rete ridges.",
      "Histology shows basal cell liquefaction degeneration and a band-like subepithelial lymphocytic infiltrate without evidence of epithelial dysplasia."
    ],
    description: "Oral lichen planus is a chronic T-cell-mediated inflammatory condition of the oral mucosa. The reticular form shows characteristic Wickham's striae and is often asymptomatic, while erosive forms cause significant pain. It carries a small but real risk of malignant transformation and requires long-term surveillance.",
    ankiStep1: "",
    ankiStep2: ""
  },
  {
  ...
  },
  {
    ...
    clues: [
      "A 45-year-old woman presents with a slow-growing painless lump in front of her right ear that has been present for three years.",
      "There is no facial weakness, and she reports no pain or rapid growth.",
      "Examination reveals a 3 cm firm, smooth, mobile mass in the superficial lobe of the right parotid gland.",
      "Ultrasound shows a well-defined hypoechoic mass with lobulated margins.",
      "Fine needle aspiration cytology demonstrates a mixture of epithelial and stromal cells in a chondromyxoid matrix.",
      "Histology after superficial parotidectomy confirms a biphasic tumour with epithelial and myoepithelial elements embedded in a chondromyxoid stroma."
    ],
    description: "Pleomorphic adenoma is the most common salivary gland tumour, accounting for the majority of parotid tumours. It is characterised by its mixed epithelial and mesenchymal-like components. Although benign, it carries a risk of malignant transformation if left untreated and recurs if incompletely excised.",
    ankiStep1: "",
    ankiStep2: ""
  },
  {
...
window.__DDLE_DICTIONARY__ = window.__DDLE_CASES__.map(function(c) { return c.answer; });
